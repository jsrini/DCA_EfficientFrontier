...
% The full-field tables above are labelled "Appendix G" in their own headers, though this section
% auto-numbers as F; step the counter so the wind-down appendix reads as H, matching that label.
...
strategies of Appendix~G. They share one idea: stay fully invested in US stock through the working
...
\noindent Each strategy is shown the same way as Appendix~G: the actual historical result, and three
