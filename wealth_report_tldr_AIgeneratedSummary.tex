...
\input{results/prose_macros.tex}
\input{results/winddown_macros.tex}
...
\vspace{1pt}
{\footnotesize\itshape Source: The Efficient Frontier of Dollar-Cost Averaging, Jaggernaut Wealth Services, LLC, June 2026. Full report at \url{https://github.com/jsrini/DCA_EfficientFrontier/blob/main/wealth_report.pdf}; data, code, and build pipeline in the same repo. Backtest and thought experiment, not financial advice. Figures nominal 2026 dollars unless labeled real; AI-written code, spot-checked --- reproduce before relying.}
